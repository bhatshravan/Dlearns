...
INSERT INTO `api` (`name`, `image`, `status`, `profilePic`,`timeStamp`,`url`) VALUES 
('~Firewolf soon to launch KSIT app', 'null', 'Being the awesomest person in hard,but Shravan being the best is soon to release a great app',  'http://orig04.deviantart.net/4be1/f/2013/133/b/4/simple_battle_born_by_lechiffre17-d6544k6.jpg','1403375851930','null')